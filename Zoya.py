#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Hadi Creation
...
logo = """
\033[1;93m|-------+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-----|
\033[1;93m|               Hadi Creation               |
\033[1;93m|This Tool is Only for Pakistani FB Accounts|
\033[1;93m|------+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+------|

\033[1;97m [💥\033[1;97mAuthor Name: Zoya Khan    💥\033[1;97m]
\033[1;97m [💥\033[1;97mWhatsap: +92315--HACKER-- 💥\033[1;97m]
\033[1;97m [💥\033[1;97mYutube Chnl: Hadi Creation💥\033[1;97m]
...
╚═╝░░╚═╝╚═╝░░╚═╝╚══════╝╚═╝
      ...
      \033[1;95m╚══════╝╚═╝╚═╝░░╚══╝░╚═════╝░╚═╝░░╚═╝
\033[1;91m•──────────────────────────•
\033[1;91mNote: \033[1;97mWelcome Hadi Creation
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://www.youtube.com/channel/UCDNry-x6BNfwj1zJLcl5ddQ')
    else:
...
def menu():
	...
	print "\033[1;97m[3]\x1b[1;93mFacebook Group Link"
	print "\033[1;97m[4]\x1b[1;93mContact With Zoya Khan Owner On Facebook"
	print "\033[1;97m[5]\x1b[1;93mSubscribe Hadi Creation Youtube Channel " 
...
def pilih():
	...
	if unikers =="":
		...
		os.system('xdg-open https://www.facebook.com/groups/270498010144815')
	        menu()
        elif unikers =="4":
		os.system('xdg-open https://www.facebook.com/profile.php?id=100000271186856')
	        menu()
	elif unikers =="5":
		os.system('xdg-open https://www.youtube.com/channel/UCDNry-x6BNfwj1zJLcl5ddQ')
	        menu()		
